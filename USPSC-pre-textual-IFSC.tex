...
\titulo{Experimental studies of the muonic component of extensive air showers}
\titleabstract{Estudos experimentais da componente mu\^onica de chuveiros atmosf\'ericos extensos}
...
% DFA ==========================================================================
    \ifthenelse{\equal{#1}{DFA}}{
        ...
        \area{Basic Physics}
  	\tipotrabalhopt{Tese (Doutor em Ci\^encias)}
        \areapt{F\'isica B\'asica}
		%\opcao{Nome da Opção}
        % O preambulo deve conter o tipo do trabalho, o objetivo, 
		% o nome da instituição, a área de concentração e opção quando houver
		\preambulo{Thesis presented to the Graduate Program in Physics at the Instituto de F\'isica de S\~ao Carlos, Universidade de S\~ao Paulo, to obtain the degree of Doctor of Sciences}
...
% DFAFC ==========================================================================
    \ifthenelse{\equal{#1}{DFAFC}}{
     	\tipotrabalho{Tese (Doutor em Ci\^encias)}
        \area{F\'isica Aplicada}
