...
\xmaxmean results of Pierre Auger Observatory~\cite{\AugerXmaxICRC2017Paper}
...
measurements of the muonic component of air showers. YYY
...
In this section we briefly mention three further
observables measured by Pierre Auger Observatory.
The first one is the longitudinal depth
of the maximum of the muon production profile (\xmumax),
which can be measured by using the temporal structure of the
water-Cherenkov detectors in highly inclined showers~\cite{\AugerMPDPaper}.
...
The second and the third observables are related to the quantity called
...
a parameter called delta. In~\cref{fig:shower:observables:further}
