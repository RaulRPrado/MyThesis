...
the \emph{hadronic} and, possibly, the \emph{muonic component}. It is also traditional
...
average energy. The lower the energies of the particles, more relevant are the energy losses
...
The lower the charged pions energies, larger the probability
...
production in EAS was studied in detail and it was found
...
\begin{wrapfigure}{r}{0.5\textwidth}
  ...
  \begin{center}
    \small \ Source: MARI\c{S}.~\cite{\IoanaICRC} 
  \end{center}
\end{wrapfigure}
...
On the right plot of~\cref{fig:shower:phen:prof}
...
Because of that, the full simulation turns out to be
...
is usually applied.~\cite{HillasThinning1,Hillas:1997tf}
...
successfully described by \emph{quantum cromodynamics} (QCD),
...
energy than the interaction of a high energy cosmic ray ($\sqrt{s}\approx 400$ \TeV for
...
\begin{figure}[!ht]
  ...
  \begin{center}
    \small Source: KAMPERT.~\cite{Kampert:2012mx} 
  \end{center}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \begin{overpic}[clip, rviewport=0 0 0.98 1,width=0.99\textwidth]{xmax_auger_icrc}
    \put(18,60){}
  \end{overpic}
  ...
  \begin{center}
    \small Source: BELLIDO.~\cite{\AugerXmaxICRC2017Paper} 
  \end{center}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \begin{overpic}[clip, rviewport=0 0 0.93 1,width=0.49\textwidth]{xmax_mean_ta}
    \put(18,60){}
  \end{overpic}
  \begin{overpic}[clip, rviewport=0 0 0.93 1,width=0.49\textwidth]{xmax_sig_ta}
    \put(18,60){}
  \end{overpic}
  ...
  \begin{center}
    \small Source: HANLON.~\cite{TAComp2017} 
  \end{center}
\end{figure}
...
by a working group formed of members of both collaborations and the most recent
...
On the top-left plot of~\cref{fig:shower:observables:nmu} we reproduce
...
\begin{figure}[!ht]
  ...
  \begin{overpic}[clip, rviewport=0 0 1 1,width=0.47\textwidth]{hires_mia_muons}
    \put(18,60){}
  \end{overpic}
  \begin{overpic}[clip, rviewport=0 -0.06 1 1,width=0.47\textwidth]{has_nmu}
    \put(18,60){}
  \end{overpic}

  \begin{overpic}[clip, rviewport=0 0 1 1.05,width=0.6\textwidth]{icetop_muons}
    \put(18,60){}
  \end{overpic}

  \caption{Muon density as measured by HiRes/MIA (top-left)~\cite{\HiResMIAMuonPaper}
    and IceTop (bottom)~\cite{\IceTopMuonPaper} and number of muons as measured by Pierre Auger Observatory
    in highly inclined showers (top-right).~\cite{\AugerHASMuonPaper}}
  \label{fig:shower:observables:nmu}

  \begin{center}
    \small Source: ABU-ZAYYAD.(top-left)~\cite{\HiResMIAMuonPaper};DEMBINSKI.(bottom)~\cite{\IceTopMuonPaper};AAB.(top-right)~\cite{\AugerHASMuonPaper} 
  \end{center}
\end{figure}
...
as muon content observable. On the bottom plot of~\cref{fig:shower:observables:nmu}
...
Even though its standard surface array
...
On the top-right plot of~\cref{fig:shower:observables:nmu} we show the
...
depends on the energy of muons, the parameter $\Lambda_\mu$ turns out to
...
\begin{figure}[!ht]
  ...
  \begin{center}
    \small Source: APEL.(left).~\cite{Apel:2017thr}; AAB.(right)~\cite{\AugerMPDPaper} 
  \end{center}
...
\begin{figure}[!ht]
  ...
  \begin{overpic}[clip, rviewport=0 -0.03 0.95 1,width=0.48\textwidth]{asymmetry_auger}
    \put(18,60){}
  \end{overpic}
  \begin{overpic}[clip, rviewport=0.05 0 0.96 1,width=0.50\textwidth]{delta_auger}
    \put(18,60){}
  \end{overpic}
  ...
  \begin{center}
    \small Source: AAB.~\cite{\AugerAsymmetryPaper,\AugerDeltaPaper} 
  \end{center}
\end{figure}
