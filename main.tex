...
\usepackage[num,overcite,abnt-emphasize=bf, abnt-thesis-year=both, abnt-repeated-author-omit=no, abnt-last-names=abnt, abnt-etal-cite=3,abnt-etal-list=3, abnt-etal-text=default, abnt-and-type=e, iso-abbreviation=standard]{abntex2cite}
...
\hypersetup{
	...
	pdfkeywords={cosmic rays}{extensive air showers}{muons}, 
...
\include{interpetration}

\include{observable}

\include{hadron}

%\include{figures_hadron}
