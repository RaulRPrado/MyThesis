...
\newcommand{\logpT}{\ensuremath{\log_{10} p_\text{T}}\xspace}
\newcommand{\logp}{\ensuremath{\log_{10} p}\xspace}
...
\newcommand{\Conex}{{\scshape Conex}\xspace}
\newcommand{\Seneca}{{\scshape Seneca}\xspace}
\newcommand{\CRMC}{{\scshape CRMC}\xspace}
\newcommand{\Mooca}{{\scshape Mooca}\xspace}
\newcommand{\Aires}{{\scshape Aires}\xspace}
\newcommand{\EGS}{{\scshape EGS4}\xspace}
...
\newcommand{\QGSJetOld}{{\scshape QGSJet\,01}\xspace}
...
\newcommand{\e}[1]{\ensuremath{\mbox{$10^{#1}$}}\xspace}
\newcommand{\E}[1]{\ensuremath{\mbox{$10^{#1}\;\eV$}}\xspace}
\newcommand{\appE}[1]{\ensuremath{\mbox{$\approx 10^{#1}\;\eV$}}\xspace}
\newcommand{\dg}[1]{\ensuremath{\mbox{#1$^\circ$}}\xspace}


\newcommand{\nmu}{\ensuremath{\mbox{$N_\mu$}}\xspace}
\newcommand{\nmumean}{\ensuremath{\mbox{$\langle N_\mu\rangle$}}\xspace}
\newcommand{\xmax}{\ensuremath{\mbox{$X_\text{max}$}}\xspace}
\newcommand{\xmaxmean}{\ensuremath{\mbox{$\langle X_\text{max}\rangle$}}\xspace}
\newcommand{\xmaxsig}{\ensuremath{\mbox{$\sigma[X_\text{max}]$}}\xspace}
\newcommand{\xmumax}{\ensuremath{\mbox{$X^\mu_\text{max}$}}\xspace}
\newcommand{\xmumaxmean}{\ensuremath{\mbox{$\langle X^\mu_\text{max}\rangle$}}\xspace}
\newcommand{\dEdX}{\ensuremath{\mbox{\text{d}$E$/\text{d}$X$}}\xspace}

%%INTERPRETATION
\def \lgnmu {$ \log_{10}N_{\mu}$\xspace}
\def \lgnmumean {$\langle \log _{10}N_{\mu} \rangle$\xspace}
\def \lgnmurms {$\sigma[\log _{10}N_{\mu}]$\xspace}
\def \cchi{$\chi^2$\xspace}
\def \chialpha{$\chi^2(\alpha)$\xspace}
\def \chibeta{$\chi^2(\beta)$\xspace}
\def \chimin{$\chi^2_\text{min}$\xspace}
\def \chiminalpha{$\chi^2_\text{min}(a)$\xspace}
\def \chiminbeta{$\chi^2_\text{min}(b)$\xspace}

%%OBSERVABLE
\def \rmu{$r_{\mu}$\xspace}
\def \rmumean{$\langle r_{\mu} \rangle$\xspace}
\def \dx{$DX$\xspace}
...
\def \neutron{n\xspace}
\def \antineutron{$\bar{\text{n}}$\xspace}
...
\newcommand{\impact}{\ensuremath{\mbox{$b_\text{r}$}}\xspace}
\newcommand{\impactmax}{\ensuremath{\mbox{$b_\text{r}^\text{cut}$}}\xspace}
