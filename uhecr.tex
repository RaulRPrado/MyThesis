...
\begin{figure}
  ...
  \begin{center}
    Source: PATRIGNANI.~\cite{\PDGPaper}
  \end{center}
\end{figure}
...
\begin{figure}
  ...
  \begin{center}
    Source: ANTONI.(top)~\cite{Antoni:2005wq}; FUHRMANN.(bottom)~\cite{Fuhrmann:2013lgx} 
  \end{center}
...
\begin{figure}
  ...
  \begin{center}
    Source: AAB.~\cite{\AugerXmaxPRDPaper,\AugerPaper} 
  \end{center}
\end{figure}
